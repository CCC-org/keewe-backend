        ...
        resultActions.andDo(restDocs.document(resource(
                ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                                ...
                                fieldWithPath("data.reaction.isClapClicked").description("인사이트 박수 클릭 여부"),
                                fieldWithPath("data.reaction.heart").description("인사이트 하트 반응 수"),
                                fieldWithPath("data.reaction.isHeartClicked").description("인사이트 하트 클릭 여부"),
                                fieldWithPath("data.reaction.sad").description("인사이트 슬픔 반응 수"),
                                fieldWithPath("data.reaction.isSadClicked").description("인사이트 슬픔 클릭 여부"),
                                fieldWithPath("data.reaction.surprise").description("인사이트 놀람 반응 수"),
                                fieldWithPath("data.reaction.isSurpriseClicked").description("인사이트 놀람 클릭 여부"),
                                fieldWithPath("data.reaction.fire").description("인사이트 불 반응 수"),
                                fieldWithPath("data.reaction.isFireClicked").description("인사이트 불 클릭 여부"),
                                fieldWithPath("data.reaction.eyes").description("인사이트 눈 반응 수"),
                                fieldWithPath("data.reaction.isEyesClicked").description("인사이트 눈 클릭 여부"),
