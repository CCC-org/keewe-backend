...
public class ChallengeAssembler {
    ...
    public ParticipationProgressResponse toParticipationProgressResponse(ChallengeParticipation participation, Long current) {
        return ParticipationProgressResponse.of(
