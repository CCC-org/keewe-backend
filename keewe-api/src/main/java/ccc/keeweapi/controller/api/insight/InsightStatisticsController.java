...
public class InsightStatisticsController {
        ...
        public FollowFromInsightCountResponse countFollowFromInsight(@PathVariable Long insightId) {
                return insightStatisticsQueryApiService.countFollowFromInsight(insightId);
        }
}
